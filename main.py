...
# score block
pygame.draw.rect(screen, (0,0,0), pygame.Rect(witdh-270, 350, 250, 85))
pygame.draw.rect(screen, (255,255,255), pygame.Rect(witdh-265, 355, 240, 75))
...
pygame.draw.rect(screen, (255,255,255), pygame.Rect(witdh-265, 505, 240, 75))
...
pygame.draw.rect(screen, (255,255,255), pygame.Rect(witdh-265, 655, 240, 75))
    ...
    for event in pygame.event.get():
        ...
        if event.type == move_down or (event.type == pygame.KEYDOWN and event.key == pygame.K_DOWN):
            ...
            if flag == True:
                ...
                game_functions.clear_row(board)
